...
export const journeyItems: JourneyItem[] = [
  { title: 'Senior Advance Analyst Specialist', discipline: 'Digital', countryCodes: ['us'], location: 'United States', period: 'Jun 2025 - Present', organization: 'Shell US Hosting Company', teaser: 'Leading AI-enabled subsurface workflows across global assets.', summary: 'I work with exploration, production, and WRFM teams to make subsurface data easier to find, use, and trust. I build governed workflows using Spotfire, Databricks, and AI, bringing exploration, reservoir, production, and spatial data together so teams can identify opportunities, complete technical assurance, and make decisions faster. My current work includes LTRO/WRFM waterflood opportunity maturation, Gap-to-Potential diagnostics, production analytics for Monagas, and early LLM/MCP workflows designed to make advanced analytics more accessible to non-technical users.', evidence: ['Led the development and adoption of governed Spotfire and Databricks workflows across exploration and subsurface teams; served as a Spotfire Customer Advisor Program representative and developed new geoscience use cases.', 'Built GoA PP SmartTrends on Databricks, transforming 72M well-log rows into 36k standardized reservoir units and reducing analysis cycles from months to hours.', 'Supported WRFM and LTRO waterflood opportunity maturation by bringing injection, production, reservoir, and well data into shared analytical workflows for Gap-to-Potential diagnostics at approximately $1B scale.', 'Developed and validated integrations with ESRI, Oracle DB, Databricks, and Denodo; prototyped LLM/MCP workflows to make advanced analytics more accessible to non-technical users.'], learningCore: 'Scalable subsurface AI earns trust when data access is governed, traceable, and built around repeatable workflows.', capabilities: ['Spotfire', 'Databricks', 'Data connectors', 'LLM/MCP'], reference: { name: 'Yann Freudenreich', role: 'Subsurface Analytics Manager' } },
  { title: 'Senior X-Digi Geoscientist (Product Owner)', discipline: 'Digital', countryCodes: ['us'], location: 'United States', period: 'Jun 2020 - May 2025', organization: 'Shell US Hosting Company', teaser: 'Bridging geoscience and product delivery to ship global exploration tools.', summary: 'I worked with geoscientists, developers, and UX designers to turn real exploration problems into products people could use. As Product Owner, I set the direction and delivery path for global tools such as XStation and ARMPlay, bringing technical, commercial, and economic data together so teams could have clearer conversations about opportunities. I also used AI and NLP to reduce manual screening and give exploration teams faster access to the insight already sitting in their data.', evidence: ['Delivered XStation, a geospatial platform giving global exploration teams access to integrated datasets and dashboards.', 'Delivered ARMPlay for Corporate ARM opportunity screening; applied AI/NLP to democratize insight generation and reduce manual effort.', 'Owned vision, roadmap, and backlog across multiple initiatives, leading dev and UX teams through PoC-led, iterative delivery to production.'], learningCore: 'Domain expertise becomes durable value when it guides product vision, experimentation, and multidisciplinary delivery.', capabilities: ['Product vision', 'Roadmap & backlog', 'UX/dev delivery', 'AI/NLP'], reference: { name: 'Francesco Menapace', role: 'GM Data and Digital Innovation' } },
  { title: 'Sr Exploration Geoscientist (Technical Lead)', discipline: 'Geo', countryCodes: ['nl'], location: 'Netherlands', period: 'Oct 2018 - Jun 2020', organization: 'Shell International E&P', teaser: "Leading 10 disciplines to revitalize Nigeria's shallow water portfolio.", summary: 'I led a multidisciplinary team to give Nigeria Shallow Water a clearer, more current view of its exploration portfolio. We brought geology, geophysics, basin modeling, and data engineering together around regional play maps, then refreshed volumes and risk for the opportunities that mattered most. I built the Hydrocarbon Distribution Dashboard across 90,000+ reservoirs and 5,000 wells, and helped make prospect maturation faster without relaxing the technical checks behind it.', evidence: ['Led a ~10-person multidisciplinary team through a two-phase portfolio revitalization: regional play maps, then volume estimates and risk assessments.', 'Built the Hydrocarbon Distribution Dashboard covering 90,000+ reservoirs and 5,000 wells.', 'Streamlined prospect maturation so multiple reservoir-seal pairs could be evaluated without compromising QC or technical quality.'], learningCore: 'Portfolio renewal works when specialists share a common evidence base for play mapping, volumes, and risk.', capabilities: ['Play mapping', 'Volumetrics & risk', 'Portfolio renewal', 'Data dashboards'], reference: { name: 'Arjan van Vliet', role: 'Energy Transition Advisor' } },
  { title: 'Sr Exploration Geoscientist', discipline: 'Geo', countryCodes: ['ng'], location: 'Nigeria', period: 'Jul 2014 - Oct 2018', organization: 'Shell Petroleum Development Company (SPDC)', teaser: 'From high-pressure wells to 22.8 MMBOE delivered to development.', summary: 'In Nigeria, I supported drilling decisions where the subsurface picture had to be right and timing mattered. As prospect owner for high-pressure, deep Gbaran wells, I provided daily geological updates, VSP support, and the model revisions needed to manage uncertainty ahead of the bit. The work moved from interpretation through formal handover to development, contributing 22.8 MMBOE in 2017, and later identified additional drilling opportunities that informed FIDs at minimal incremental exploration cost.', evidence: ['Prospect owner for Gbaran 26 and 27: high-pressure wells with targets deeper than 16,000 ft; provided daily operational geology and Look-Ahead VSP support.', 'Delivered subsurface model updates, velocity models, volumetrics/QI evaluations, and formal exploration-to-development handovers.', "Contributed 22.8 MMBOE to Development in 2017, approximately 15% of Nigeria's Contingent Resources target, using CTD, AVD, and Syn2D workflows.", 'Took over HD-JK to identify drilling opportunities that added resources at minimal incremental exploration cost and positively influenced FIDs.'], learningCore: 'Operational geoscience connects daily well decisions to credible subsurface models and development handovers.', capabilities: ['HP wells', 'Operational geology', 'VSP/Look-Ahead VSP', 'Velocity models'], reference: { name: 'Manuel Poupon', role: 'Nigeria DW Principal' } },
  { title: 'Senior Seismic Interpreter', discipline: 'Geo', countryCodes: ['qa'], location: 'Qatar', period: 'Feb 2012 - Jul 2014', organization: 'Qatar Shell Service Company (QSSC)', teaser: 'Showcasing a world-first fiber-optic seismic trial to senior stakeholders.', summary: 'In Qatar, I used seismic and well data to give drilling and appraisal teams a sharper view beneath critical wells. I handled well ties, synthetics, target-depth functions, and VSP operations for exploration and North Field appraisal activity alongside Qatar Petroleum. I also coordinated seismic processing with the Netherlands team and helped turn a 4,000-channel battery-less fiber-optic seismic trial into a clear technical story for senior stakeholders.', evidence: ['Delivered well-seismic calibration, synthetic generation, and target-depth functions; planned and managed VSP operations for QSD-1 and North Field appraisal wells with Qatar Petroleum.', 'Led 2012-2013 seismic processing for Qatar, coordinating virtually with the Netherlands processing team.', 'Processed and showcased a ~4,000-channel battery-less fiber-optic seismic trial (Shell/PGS) to senior stakeholders.'], learningCore: 'Seismic innovation becomes valuable when rigorous calibration is paired with clear communication to decision makers.', capabilities: ['VSP planning', 'Well-seismic calibration', 'Seismic processing', 'Fiber-optic seismic'], reference: { name: 'Craig Harvey', role: 'Exploration Manager EMEA' } },
  { title: 'Exploration Geoscientist (Consulting)', discipline: 'Geo', countryCodes: ['ve', 'co', 'mx'], location: 'Venezuela | Colombia | Mexico', period: '2006 - Jan 2012', organization: 'Consulting', teaser: 'Building a cross-basin foundation across Venezuela, Colombia, and Mexico.', summary: 'My early career was spent learning the full seismic workflow across Venezuela, Colombia, and Mexico, from acquisition QC and processing to interpretation and drilling preparation. I worked in both onshore and deepwater settings, helping design a 3D survey in Catatumbo and supporting well proposals that led to new finds in Colombia. That hands-on foundation taught me how much technical decisions depend on data quality, uncertainty, and a practical understanding of the operation.', evidence: ['Gained hands-on exposure to the full seismic cycle: 2 yrs acquisition QC, 6 mo processing fundamentals, and 3+ yrs interpretation across onshore and deepwater settings.', 'Contributed to a ~60 km2 3D survey design in Catatumbo and supported well proposals that led to new finds in Colombia.', 'Supported deepwater drilling preparation for Gulf of Mexico and offshore Venezuela (MSLNG), building velocity models for pore-pressure and fracture-gradient prediction ahead of operations.'], learningCore: 'Full-cycle exposure to acquisition, processing, and interpretation builds the judgment needed for complex exploration problems.', capabilities: ['Acquisition QC', 'Processing', 'AVO & spectral decomposition', 'Drilling preparation'] },
]
...
export const journeyCvProfile: JourneyCvProfile = {
  ...
  achievements: [
    'Contributed 22.8 MMBOE to Development from a high-pressure exploration portfolio.',
  ...
  acts: [
    {
      ...
      body: 'After cycling through Port Harcourt, I started seeing a fine black residue on my clothes, at home, and across nearby surfaces. One afternoon, I saw it on my young son\'s hands and clothes after only a few minutes at a nearby playground. The concern was no longer abstract. Many people had noticed it, but there was no public data showing what was in the air.',
    },
    {
      id: 'signal',

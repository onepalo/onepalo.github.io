...
export const journeyItems: JourneyItem[] = [
  { title: 'Senior Advance Analyst Specialist', discipline: 'Digital', countryCodes: ['us'], location: 'United States', period: 'Jun 2025 - Present', organization: 'Shell US Hosting Company', teaser: 'Driving AI-enabled analytics adoption across subsurface workflows.', summary: 'I work with exploration, production, and WRFM teams to make subsurface data easier to find, use, and trust. I build governed workflows using Spotfire, Databricks, and AI, bringing exploration, reservoir, production, and spatial data together so teams can identify opportunities, complete technical assurance, and make decisions faster. My current work includes LTRO/WRFM waterflood opportunity maturation, approximately $1B in Gap-to-Potential diagnostics, production analytics for Monagas, and early LLM/MCP workflows designed to make advanced analytics more accessible to non-technical users.', evidence: ['Connected Spotfire to ESRI, Oracle DB, Databricks, and Denodo; formalized geoscience analytics use cases as Spotfire CAP representative.', 'Delivered Yet2Find, BPA2 QC, PSI, and GoA Production tools; contributed to WRFM Gap-to-Potential diagnostics and prototyped LLM/MCP workflows.', 'Built GoA PP SmartTrends on Databricks, turning 72M well-log rows into 36k standardized reservoir units, cutting analysis cycle time from months to hours.'], learningCore: 'Scalable subsurface AI earns trust when data access is governed, traceable, and built around repeatable workflows.', capabilities: ['Spotfire', 'Databricks', 'Data connectors', 'LLM/MCP'], reference: { name: 'Yann Freudenreich', role: 'Subsurface Analytics Manager' } },

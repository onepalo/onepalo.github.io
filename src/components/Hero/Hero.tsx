        ...
        <div className="hero-ai-perspective-backdrop" role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) closeAiPerspective() }}>
          <section className="hero-ai-perspective-dialog" id="ai-perspective-dialog" role="dialog" aria-modal="true" aria-label="Rafael's perspective on working with AI">
            ...
            <div className="hero-ai-perspective-copy">
              ...
              <p>More importantly, AI is changing how we think. It lowers the cost of exploration, makes it easier to approach problems from multiple angles, and expands our capacity to learn across domains. At its best, it can make us more curious, more informed, and more connected to ideas outside our usual expertise. The challenge is ensuring that greater access to information leads to deeper understanding rather than simply more content.</p>

...
const testimonials: readonly Testimonial[] = ([
  ...
  },
  {
    ...
    fullRecommendation: [
      ...
      'Rafael connects business challenges with innovative solutions while keeping end users in mind. He takes an enterprise-first approach, focusing on the problems that matter most to the business and delivering across reporting lines, business units, and other artificial boundaries.',
